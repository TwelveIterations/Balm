...
public class FabricBalmMenuScreenFactory implements BalmMenuScreenFactory {

    public static final BalmMenuScreenFactory INSTANCE = new FabricBalmMenuScreenFactory();
