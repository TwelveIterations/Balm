...
public class FabricBalmTooltipComponentRegistrar implements BalmTooltipComponentRegistrar {

    public static final FabricBalmTooltipComponentRegistrar INSTANCE = new FabricBalmTooltipComponentRegistrar();
