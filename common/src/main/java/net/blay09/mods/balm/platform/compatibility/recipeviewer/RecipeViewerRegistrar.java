...
public interface RecipeViewerRegistrar {
    <T> RecipeViewerRecipeTypeRegistration<T> registerCustomRecipeType(ResourceLocation identifier, Class<T> recipeClass);

    <TRecipeInput extends RecipeInput, TRecipe extends Recipe<TRecipeInput>> RecipeViewerVanillaRecipeTypeRegistration<TRecipeInput, TRecipe> registerRecipeType(ResourceLocation identifier, Class<TRecipe> recipeClass);
