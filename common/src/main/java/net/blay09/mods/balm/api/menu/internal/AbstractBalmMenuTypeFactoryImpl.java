package net.blay09.mods.balm.api.menu.internal;

import net.blay09.mods.balm.api.menu.BalmMenuFactory;
import net.blay09.mods.balm.api.menu.BalmMenuTypeFactory;
import net.blay09.mods.balm.api.menu.BalmMenuTypeRegistration;
...
public abstract class AbstractBalmMenuTypeFactoryImpl implements BalmMenuTypeFactory {

    private final BalmRegistrar registrar;
    private final String namespace;

    protected AbstractBalmMenuTypeFactoryImpl(BalmRegistrar registrar, String namespace) {
