...
public class ExampleDeclarativeConfig {
    public static final ConfigSchemaBuilder schema = BalmConfigSchema.create(new ResourceLocation("balm", "client"));
    ...
    public static final ConfiguredSet<ResourceLocation> exampleResourceLocationSet = schema
            ...
            .synced()
            .setOf(ResourceLocation.class, Set.of(new ResourceLocation("dirt"), new ResourceLocation("diamond")));
