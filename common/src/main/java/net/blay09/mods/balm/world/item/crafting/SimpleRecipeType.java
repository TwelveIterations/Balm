...
public class SimpleRecipeType<T extends Recipe<?>> implements RecipeType<T> {
    ...
    public static <TRecipeInput extends RecipeInput, TRecipe extends Recipe<TRecipeInput>> Function<ResourceLocation, SimpleRecipeType<TRecipe>> of(Class<TRecipe> clazz) {
