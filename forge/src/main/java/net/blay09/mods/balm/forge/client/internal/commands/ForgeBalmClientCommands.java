package net.blay09.mods.balm.forge.client.internal.commands;
...
public class ForgeBalmClientCommands implements BalmClientCommands {
    ...
    public ForgeBalmClientCommands() {
