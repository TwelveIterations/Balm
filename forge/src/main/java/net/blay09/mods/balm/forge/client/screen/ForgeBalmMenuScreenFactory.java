...
public class ForgeBalmMenuScreenFactory implements BalmMenuScreenFactory {

    public static final BalmMenuScreenFactory INSTANCE = new ForgeBalmMenuScreenFactory();
