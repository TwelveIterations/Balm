...
public class ForgeBalmEventMappings {
    ...
    public static void bind() {
        ...
        bindSimple(LivingEntityCallback.Damage.Before.EVENT, LivingDamageEvent.BUS, (event, it) -> event.setAmount(Math.max(0, it.computeDamage(event.getEntity(), event.getSource(), event.getAmount()))));
